...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/workspace/cloudflare-sample-app/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/workspace/cloudflare-sample-app/.wrangler/tmp/bundle-KbSHRF/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/workspace/cloudflare-sample-app/.wrangler/tmp/bundle-KbSHRF/middleware-insertion-facade.js";
